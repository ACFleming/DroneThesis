...
int main (int argc, char* argv[]){
    ...
    for(int test = rand_seed_start; test < rand_seed_start + num_tests; test ++){
        for (int source_count = source_start; source_count < max_sources; source_count++){
                ...
                Agent a1 = Agent("Drone1", 0 ,15, field_x_width, field_y_length, max_range,speed, &certainty_grids);
                Agent a2 = Agent("Drone2", 15 , 0, field_x_width, field_y_length, max_range,speed, &certainty_grids);
